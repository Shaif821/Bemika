    ...
    <div class="omalles">
                ...
                <div class="omwrap">
                    <div class="wrap outform">
                        <form method="post" enctype="multipart/form-data">
                            <h2 class="message"><?php echo $updatecontent; ?></h2>
                            <input class="title" type="text" name="title" value="<?php echo $contentData['title']; ?>" placeholder="<?php echo $contentData['title']; ?>">
                            ...
                            <textarea onkeyup="count();" id="counttext" name="description" value="'<?php echo $contentData['text_content'];?>" placeholder="<?php echo $contentData['text_content']; ?>" class="textarea" rows="15" cols="90" ></textarea>
        ...
        <div class="col pubb">
            <div class="wrap publish">
                ...
                <?php if($contentData['active'] == 0){
                    echo '<input class="verzenden" type="submit" name="publish" value="Online plaatsen"></form>';
                } elseif($contentData['active'] == 1) {
                    echo '<input class="verzenden" type="submit" name="update" value="Update"></form>';
                }
                ?>
